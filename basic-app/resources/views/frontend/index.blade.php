...
@section('main')
    <!-- banner-area -->
    @include('frontend.homeAll.homeSlide')
    <!-- banner-area-end -->

    <!-- about-area -->
    @include('frontend.homeAll.homeAbout')
    <!-- about-area-end -->
                    ...
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/services_light_icon01.png') }}" alt="">
                                <img class="dark"
                                    src="{{ asset('frontend/assets/img/icons/services_icon01.png') }}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/services_light_icon02.png') }}" alt="">
                                <img class="dark"
                                    src="{{ asset('frontend/assets/img/icons/services_icon02.png') }}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/services_light_icon03.png') }}" alt="">
                                <img class="dark"
                                    src="{{ asset('frontend/assets/img/icons/services_icon03.png') }}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/services_light_icon04.png') }}" alt="">
                                <img class="dark"
                                    src="{{ asset('frontend/assets/img/icons/services_icon04.png') }}" alt="">
                            </div>
            ...
            <div class="row work__process__wrap">
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light"
                                src="{{ asset('frontend/assets/img/icons/wp_light_icon01.png') }}" alt="">
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light"
                                src="{{ asset('frontend/assets/img/icons/wp_light_icon02.png') }}" alt="">
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light"
                                src="{{ asset('frontend/assets/img/icons/wp_light_icon03.png') }}" alt="">
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light"
                                src="{{ asset('frontend/assets/img/icons/wp_light_icon04.png') }}" alt="">
                            ...
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        ...
                                        <h4 class="title"><a href="portfolio-details.html">Banking
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="portfolio-details.html">Nature of
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="portfolio-details.html">Product Design
                                                and Development</a></h4>
                                        <a href="portfolio-details.html" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                ...
                <div class="col-lg-6">
                    <div class="partner__content">
                        <div class="section__title">
                            ...
                            <h2 class="title">I proud to have collaborated with some awesome companies
                            </h2>
                        </div>
            ...
            <div class="row gx-0 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        ...
                        <div class="blog__post__content">
                            <span class="date">13 january 2021</span>
                            <h3 class="title"><a href="blog-details.html">How to increase your
                                    productivity at work - 2021</a></h3>
                            <a href="blog-details.html" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
